    ...
    if(inputa == 8) ## enter 음성출력 
        for i in range(0,len(aa),1)
            ...
            if(len(hap) == len(aa))
                ...
                encText = urllib.parse.quote(hap)
                data = speaker=jinho&speed=0&text= + encText;
                url = httpsopenapi.naver.comv1voicetts.bin
